...
run "typeFacts 样式恒量 DOM 事实溯源"     "$PY" scripts/tests/test_type_facts.py
...
run "check_device_asset_variants 双稿资源分档清单" "$PY" scripts/tests/test_check_device_asset_variants.py
...
run "audit_run 编排归一与聚合"            "$PY" scripts/tests/test_audit_run.py
